...
urlpatterns = [
    ...
    path('student/<int:student_id>/course/<int:course_code>/', views.add_course_to_schedule,name='add_course_to_schedule'),
    path('student/<int:student_id>/schedule/', views.get_student_schedule, name='get_student_schedule'),
    path('student/deadline/', views.student_deadlines, name='get_student_deadlines'),
]
